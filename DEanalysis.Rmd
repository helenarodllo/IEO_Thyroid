...
```{r pdist, echo=FALSE, out.width="400px", fig.cap="Supplementary figure 16. Distribution of raw p-values for an F-test on every gene between tumor and normal samples.\\label{fig:pdist}"}
...
```{r sampleClusteringAdjust, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Supplementary figure 18. Hierarchical clustering of the samples after adjusting for surrogate variables\\label{fig:sampleClusteringAdjust}"}
...
```{r sampleClusteringRemov, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Supplementary figure 19: Hierarchical clustering after removing samplevial effect.\\label{fig:sampleClusteringRemov}"}
...
```{r VolcanoPlot, fig.height=5, fig.width=7, echo=FALSE, message=FALSE, fig.cap="Supplementary figure 20. Volcano Plot of normalized genes.\\label{fig:VolcanoPlot}"}
