...
Thyroid carcinoma (THCA) is the most common endocrine malignancy. It is thought that more than 60% of the population has thyroid nodules, but only a 8-16% of these will become malignant. Thus, TC only represents a 2.3% of all cancers worldwide, but its incidence is increasing.  
...
There are several types of THCA, but the most common come from follicuar cells and are well differentiated carcinomas, and most of them of the papillary sub-type. In fact, 80% of all THCA are papillary carcinomas, which are also the ones with best prognosis. These usually contain BRAF mutations, and are the less aggressive types. This is the kind of THCA we will focus on, since all TGCA data corresponds to this tumor type.  
