...
DEgenes <- readRDS("DEgenes_voom.rds")
```
...
DE <- GeneSet(EntrezIdentifier("org.Hs.eg.db"), geneIds = rownames(DEgenes), setName = "DE tumor genes")
details(DE)
DEsym <- mapIdentifiers(DE, SymbolIdentifier())
DEsym
```
