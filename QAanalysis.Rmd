...
plotMDS(dge.filt4, labels= as.character(thca.filt4$type), col = c("red", "blue")[as.integer(dge.filt4$samples$group)], cex = 0.7, main ="Sample type MDS", xlab = "Leading logFC dim1", ylab = "Leading logFC dim2")
...
```{r sampleClustering, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Hierarchical clustering of the samples by TSS.\\label{fig:sampleClustering}"}
...
```{r sampleClustering2, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Hierarchical clustering of the samples by Plate.\\label{fig:sampleClustering2}"}
logCPM <- cpm(dge.filt4, log=TRUE, prior.count=3)
d <- as.dist(1-cor(logCPM, method="spearman"))
sampleClustering <- hclust(d)
...
```{r sampleClustering3, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Hierarchical clustering of the samples by Portion Analytic.\\label{fig:sampleClustering3}"}
logCPM <- cpm(dge.filt4, log=TRUE, prior.count=3)
d <- as.dist(1-cor(logCPM, method="spearman"))
sampleClustering <- hclust(d)
...
```{r sampleClustering4, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Hierarchical clustering of the samples by Sample vial.\\label{fig:sampleClustering4}"}
logCPM <- cpm(dge.filt4, log=TRUE, prior.count=3)
d <- as.dist(1-cor(logCPM, method="spearman"))
sampleClustering <- hclust(d)
...
```{r mdsPlot, fig.height=7, fig.width=14, dpi=100, echo=FALSE, fig.cap="Multidimensional scaling plot of the samples.\\label{fig:mdsPlot}"}
