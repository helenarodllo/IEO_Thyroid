...
```{r numvars, fig.height=20, fig.width=25, fig.cap="Number of samples per cathegory. From top to bottom: type, gender and age."}
par(mfrow=c(3, 1))
#Type
...
```{r libsizes, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Library sizes. Milions of reads per sample in increasing order."}
...
```{r filtlibsizes, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Library size. Milions of reads per sample in increasing order after filtering."}
...
```{r distRawExp, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Non-parametric density distribution of expression profiles per sample. Shows density of genes per log2CPM. Tumor samples are ploted in the left and normal samples in the right.", message=FALSE}
par(mfrow=c(1, 2))
...
```{r distboxplot, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Box plot. Distribution of the expression values across samples.", message=FALSE}
...
```{r exprdist, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Distribution of expression level. Shows the frequency of each gene per average expression level."}
...
```{r expfilt1, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Distribution of average expression level per gene. Filtering out genes with `r nsamplescutoff` samples with a log2CPM lower than `r cpmcutoff`. Number of genes passing the filter are shown in red."}
...
```{r expfilt2, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="Distribution of average expression level per gene with a minimum log2CPM of 3. Numbers of genes passing the previous filter are shown in red. Number of genes passing the current filter are shown in blue"}
h <- hist(avgexp, xlab = expression("Expression level (" * log[2] * "CPM)"), 
          main = "Average expression level", ylab ="Frequency", las = 1, 
...
```{r maPlotsGeneral2, fig.height=6, fig.width=12, out.width="800px", echo=FALSE, fig.cap="MA-plots of non-normalized data. Shows fold change (FC) in logarithmic scale in function of the average expression."}
...
```{r maPlotsTumor, echo=FALSE, fig.height=36, fig.width=10, dpi=100, fig.cap="MA-plots for each tumor sample. Show fold change in logarithmic scale in function of the average expression"}
...
```{r maPlotsNormal, echo=FALSE, fig.height=18, fig.width=10, dpi=100, fig.cap="MA-plots for each normal sample. Show fold change in logarithmic scale in function of the average expression."}
...
```{r MDS, echo=FALSE, fig.height=6, fig.width=12, out.width="800px", fig.cap="MDS plot. Shows tumor (blue) and normal (orange) samples grouped by fold change in logarithmic scale"}
...
legend("topleft", c("Female", "Male"), fill = c("salmon", "darkolivegreen3"), inset = 0.5, cex = 1)
```

This plot shows that there is not a cluster that clearly divides both groups, so we decide not to continue analyzing differential expressed genes within gender.
