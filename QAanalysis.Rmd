...
```{r expfilt1, echo=FALSE, fig.height=6, fig.width=12, fig.margin= TRUE, out.width="800px", fig.align='center', fig.cap="Distribution of average expression level per gene. Filtering out genes with `r nsamplescutoff` samples with a log2CPM lower than `r cpmcutoff`. Number of genes passing the filter are shown in red."}
...
```{r expfilt2, echo=FALSE, fig.height=6, fig.width=12, fig.margin= TRUE, out.width="800px", fig.align='center', fig.cap="Distribution of average expression level per gene with a minimum log2CPM of 3. Numbers of genes passing the previous filter are shown in red. Number of genes passing the current filter are shown in blue"}
h <- hist(avgexp, xlab = expression("Expression level (" * log[2] * "CPM)"), 
          main = "Average expression level", ylab ="Frequency", las = 1, 
...
```{r MDS, echo=FALSE, fig.height=6, fig.width=12, fig.margin= TRUE, out.width="800px", fig.align='center', fig.cap="MDS plot. Shows tumor (blue) and normal (orange) samples grouped by fold change in logarithmic scale"}
...
```{r MDS2, fig.height=6, fig.width=12, out.width="800px", fig.margin= TRUE, fig.align='center', echo=FALSE, fig.cap="MDS of the samples according to its gender (male or female)."}
