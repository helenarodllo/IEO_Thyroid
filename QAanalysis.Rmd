...
```{r MDS, echo=FALSE, fig.height=10, fig.width=12, fig.margin= TRUE, out.width="800px", fig.align='center', fig.cap="MDS plot. Shows tumor (blue) and normal (orange) samples grouped by fold change in logarithmic scale"}
...
```{r MDS2, fig.height=10, fig.width=12, out.width="800px", fig.margin= TRUE, fig.align='center', echo=FALSE, fig.cap="MDS of the samples according to its gender (male or female)."}
