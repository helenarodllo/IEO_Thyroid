...
We can plot raw p-values as function on their ranking, and drawing a line through the origin with slope α/m, provides a geometrical explanation for how FDR values are derived and why some of them are identical.
